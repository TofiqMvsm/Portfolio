...
const Home = () => {
  ...
  return (
    <section  className={`${dark ? 'dark:bg-gray-900' : 'bg-white'} text-center relative h-screen flex flex-col justify-center items-center gap-5 px-5`}>
        ...
        <p >A Frontend developer, self-motivated and love to learn new technologies.</p>
        <button onClick={()=>navigate('/about')} className={`${dark ? 'dark-btn' : 'light-btn'} transition-all duration-200 font-semibold home-btn`}>
          More About Me
        </button>
    </section>
  )
